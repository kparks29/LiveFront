        ...
        <div className="h-full flex flex-row gap-3 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="flex flex-row items-center text-gray-600 font-extralight">
              ...
              <DotFilledIcon className="mx-1 text-gray-600 font-extralight hidden md:visible" />
              <span className="hidden md:visible">{event.venue.name}</span>
            </p>
            <p className="visible md:hidden">{event.venue.name}</p>
          </div>
          <div className="w-30">
            {event.url !== undefined ? 
              <a 
                ...
                className="h-20 w-full flex items-center hover:text-blue-500 hover:cursor-pointer"
